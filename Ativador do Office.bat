@ECHO  off
	...
	copy "Ativadores-superinner.zip" C:\Tools\Ativadores\
	robocopy 7zip\ C:\Tools\Ativadores\7zip\
	copy Ativador_Agendado.bat C:\Tools\Ativadores\
	copy Agendar_Ativacao.bat C:\Tools\Ativadores\
	echo.
	echo # - - - - - - - - - - - - - - - - - - - - - - - - - #
